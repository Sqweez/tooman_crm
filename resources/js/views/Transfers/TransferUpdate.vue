<template>
    <v-card>
        <v-card-title>Обновление перемещения</v-card-title>
        <v-card-text>
...
export default {
    ...
    methods: {
        ...
        async onTransfer() {
            ...
            await axios.post(`/api/transfers/products/update`, payload);
            ...
            this.$toast.success('Перемещение обновлено успешно!');
