                ...
                <v-card-text>
                    ...
                    >
                        ...
                        <template v-slot:item.subcategory="{item}">
                            {{ everySubcategory.find(i => i.id == item.subcategory_id).subcategory_name || '-' }}
                        </template>
...
export default {
    ...
    computed: {
        ...
        everySubcategory () {
            let subcategories = [];
            this.$store.getters.categories.forEach(c => {
                c.subcategories.forEach(s => {
                    subcategories.push({
                        ...s,
                        name: `${s.subcategory_name} (${c.name})`
                    });
                })
            })
