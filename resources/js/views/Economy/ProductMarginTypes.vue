        ...
        <v-card>
            <v-card-text>
                <div class="d-flex mt-4">
                    ...
                    <v-btn color="primary" class="ml-5" :outlined="activeSegment !== 'products'" @click="activeSegment = 'products'">
                        Параметры товаров
                    </v-btn>
                </div>
            </v-card-text>
        </v-card>
        <margin-types v-if="activeSegment === 'settings'"/>
        <div v-if="activeSegment === 'products'">
